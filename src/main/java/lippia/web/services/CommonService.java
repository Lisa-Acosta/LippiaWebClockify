...
import static lippia.web.constants.ReportConstants.*;
...
public class CommonService extends ActionManager {
    ...
    public static void clickLink(String link) throws InterruptedException {
        ...
        links.put("Manage workspaces", LINK_WORKSPACE_MANAGE);
        links.put("Reports", LINK_REPORTE);
    ...
    public static void clickButton(String button) throws InterruptedException {
        ...
        buttons.put("ADD", BUTTON_ADD_WORK);
        buttons.put("Weekly", THIS_WEEK_BUTTON);
        buttons.put("Export", EXPORT_BUTTON);
        buttons.put("Save as PDF", SAVE_PDF_BUTTON);
    ...
    public static void visualizarDescarga() {
        waitVisibility(DOWNLOAD_PDF);
        Assert.assertTrue(isVisible(DOWNLOAD_PDF));
    }
}

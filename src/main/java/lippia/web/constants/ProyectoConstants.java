...
public class ProyectoConstants {
    ...
    public static final String CHECK_PUBLIC ="xpath://app-checkbox[@class='ng-untouched ng-pristine ng-valid']";
    public static final String NAME_PROJECTS ="xpath://a[.='%s']";
    public static final String PROJECT_CREATED ="xpath://*[contains(@aria-label,'has been created')]";
